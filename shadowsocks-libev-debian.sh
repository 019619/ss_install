...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/019619/ss_install/master/shadowsocks-libev-debian.sh"
}
...
pre_install(){
    ...
    read -p "(Default password: asdfgh):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="asdfgh"
    echo
    echo "---------------------------"
